...
|----------|------|----------|
| Windows | `MeterAI_1.4.1_x64-setup.exe` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.3.0/MeterAI_1.4.1_x64-setup.exe) |
...
| macOS (Intel) | `MeterAI_1.4.1_x64.dmg` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.3.0/MeterAI_1.4.1_x64.dmg) |
...
| Linux | `MeterAI_1.4.1_amd64.AppImage` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.3.0/MeterAI_1.4.1_amd64.AppImage) |
| Linux | `MeterAI_1.4.1_amd64.deb` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.3.0/MeterAI_1.4.1_amd64.deb) |
