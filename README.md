...
|----------|------|----------|
| Windows | `MeterAI_1.4.2_x64-setup.exe` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/MeterAI_1.4.2_x64-setup.exe) |
| Windows | `MeterAI_1.4.2_x64_en-US.msi` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/MeterAI_1.4.2_x64_en-US.msi) |
| macOS (Intel) | `MeterAI_1.4.2_x64.dmg` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/MeterAI_1.4.2_x64.dmg) |
| macOS (Apple Silicon) | `MeterAI_1.4.2_aarch64.dmg` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/MeterAI_1.4.2_aarch64.dmg) |
| Linux | `meter-ai_1.4.2_amd64.AppImage` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/meter-ai_1.4.2_amd64.AppImage) |
| Linux | `meter-ai_1.4.2_amd64.deb` | [Download](https://github.com/PopeYeahWine/MeterAI/releases/download/v1.4.2/meter-ai_1.4.2_amd64.deb) |
